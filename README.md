...
| using gpt-5.6-sol xhigh in omp with imagegen | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-omp-with-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-omp-with-imagegen/ |
| run a workflow in omp with gpt-5.6-sol xhigh & imagegen | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-workflow-omp-with-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-workflow-omp-with-imagegen/ |
| combine multiple workflows in omp with gpt-5.6-sol xhigh & imagegen | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-multi-workflow-omp-with-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-multi-workflow-omp-with-imagegen/ |
| using gpt-5.6-sol max + imagegen (gpt-image-2) in codex | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-codex-with-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-codex-with-imagegen/ |
| using gpt-5.6-sol ultra + imagegen (gpt-image-2) in codex | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-ultra-codex-with-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-ultra-codex-with-imagegen/ |
