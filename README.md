...
| using gpt-5.6-sol xhigh in omp | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-no-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-no-imagegen/ |
| run a workflow in omp with gpt-5.6-sol xhigh | https://github.com/Recursive-Self-Improving/qingdao-badaguan-threejs-gpt-5.6-sol-workflow-no-imagegen | https://recursive-self-improving.github.io/qingdao-badaguan-threejs-gpt-5.6-sol-workflow-no-imagegen/ |
